...
if(isset($_POST['simpan'])){
	...
	if(cekPinjam($kon, $id_anggota) && $stok > 0){
		...
		$idp=$wd["id_pinjam"];
		$sql1 = mysqli_query($kon,"INSERT INTO detail_pinjam(id_pinjam,id_buku) values('$id_pinjam','$id_buku')");
	...
	echo"<script>alert('data gagal diubah.');window.location='form-pinjam.php';</script>";
}
?>